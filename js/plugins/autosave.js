/*: * @plugindesc Allows creating, loading, and deleting save files with plugin
commands.
* @author Sabi
*
* @help
...
(function() {var Sabi_Game_Interpreter_pluginCommand = Game_Interpreter.prototype.pluginCommand;
